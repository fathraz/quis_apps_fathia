...
export class Tab2Page {
  ...
  async getData() 
  {
    try 
    {
      const res = await axios.get('http://localhost/api_tugas/get_data_mahasiswa.php');
  ...
  async deleteData(id)
  {
    ...
    try
    {
      const res = await axios.post('http://localhost/api_tugas/delete_data_mahasiswa.php', fd);
